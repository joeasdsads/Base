...
namespace rust {
	...
	namespace classes 
	{
		...
		public:
			union {
				DEFINE_MEMBER_N(Vector, pointStart, 0x14);
				DEFINE_MEMBER_N(Vector, pointEnd, 0x18);
				DEFINE_MEMBER_N(unsigned int, hitID, 0x2C);
				DEFINE_MEMBER_N(unsigned int, hitBone, 0x30);
				DEFINE_MEMBER_N(Vector, hitNormalLocal, 0x34);
				DEFINE_MEMBER_N(Vector, hitPositionLocal, 0x40);
				DEFINE_MEMBER_N(Vector, hitNormalWorld, 0x4C);
				DEFINE_MEMBER_N(Vector, hitPositionWorld, 0x48);
		...
		public:
			...
			int iget_layer() 
			{ 
				return mem::read<int>(reinterpret_cast<uintptr_t>(this) + 0x50); 
			}
		};
		...
		public:
			union {
				...
				DEFINE_MEMBER_N(Vector, hitVelocity, 0x20);
		...
		public:
			union {
				...
				DEFINE_MEMBER_N(Vector, AttackRay, 0x14);
				...
				DEFINE_MEMBER_N(Vector, HitPoint, 0x90);
				DEFINE_MEMBER_N(Vector, HitNormal, 0x9C);
				DEFINE_MEMBER_N(Vector, HitNormal, 0x9C);
